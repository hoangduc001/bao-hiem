                                    ...
                                    <div class="tab-nav-ctn">
                                        ...
                                        <div class="left-navigate">
                                            <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="history-tab" data-toggle="tab" href="#history" role="tab" aria-controls="history" aria-selected="false">Lịch sử giao dịch</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="join-course-ctn col-12">
                                                            <div class="join-item">
                                                                ...
                                                                <div class="right-ctn col-7">
                                                                    <div class="title-ctn">
                                                                        <h5>Thi chứng chỉ phụ trợ bảo hiểm</h5>
                                                                    </div>
                                                                    <div class="progress-bar-ctn">
                                                                        <p style="width:80%" data-value="80"></p>
                                                                        <div class="progress">
                                                                    ...
                                                                    <div class="btn-cont">
                                                                        <a href="#" class="btn btn-default btn-enroll btn-enroll-test">Tiếp tục thi</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="bought-course-ctn ">
                                                            <div class="bought-wrapper ">
                                                                <div class="bought-item ">
                                                                    ...
                                                                    <div class="title-ctn">
                                                                        <h5>Luyện thi chứng chỉ đại lý bảo hiểm</h5>
                                                                    </div>
                                                                    <div class="tutor">
                                                                        <a href="#"> Loại hình 5</a>
                                                                    </div>
                                                                    <div class="btn-cont">
                                                                        <a href="#" class="btn btn-default btn-enroll btn-enroll-test">Mô tả đề thi</a>
                                                                        <a href="#" class="btn btn-default btn-enroll btn-enroll-test">Vào học</a>
                                                                    </div>
                                                                </div>
                                                                <div class="bought-item ">
                                            ...
                                            <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                                                <div class="history-content">
                                                    <div class="tab-main">
                                                        <div class="tabs tabs-transaction">
                                                            <div class="tab">
                                                                <input type="radio" name="css-tabs" id="tab-in" checked class="tab-switch">
                                                                <label for="tab-in" class="tab-label">Biến động nạp tiền </label>
                                                                <div class="tab-content">
                                                                    <div class="money-in">
                                                                        <ul>
                                                                            <li><span class="add">+</span><span class="quantity">500</span> xu vào tài khoản, giao dịch ngày <span class="date-transaction">19/05/2020</span>  , số xu hiện có: <span class="available-coin">500</span> xu</li>
                                                                            <li><span class="add">+</span><span class="quantity">500</span> xu vào tài khoản, giao dịch ngày <span class="date-transaction">19/05/2020</span>  , số xu hiện có: <span class="available-coin">500</span> xu</li>
                                                                            <li><span class="add">+</span><span class="quantity">500</span> xu vào tài khoản, giao dịch ngày <span class="date-transaction">19/05/2020</span>  , số xu hiện có: <span class="available-coin">500</span> xu</li>
                                                                        </ul>
                                                                    </div>
                                                            ...
                                                            <div class="tab">
                                                                ...
                                                                <label for="tab-2" class="tab-label">Biến động mua</label>
                                                                <div class="tab-content">
                                                                <div class="money-out">
                                                                        <ul>
                                                                            <li><span class="add">+</span><span class="quantity">500</span> xu vào tài khoản, giao dịch ngày <span class="date-transaction">19/05/2020</span>  , số xu hiện có: <span class="available-coin">500</span> xu</li>
